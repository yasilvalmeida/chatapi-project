...
<html>
    ...
    <head>
        <title>Queue - SMS Sending System</title>
        <?php
                    ...
                    <div id="content">
                        ...
                        <div class="container-fluid">
                            <div class="d-sm-flex justify-content-between align-items-center mb-4">
                                <h3 class="text-dark mb-0">Queue</h3>
                            </div>
                            <div class="row">
                                <div class="col-12">
                                    <div class="card">
                                        <div class="card-body">
                                            <form class="user">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="totalMessages" disabled />
                                                    <br>
                                                    ...
                                                    <hr />
                                                    <div id="queue_state" class="d-flex justify-content-center" role="alert">
                                                    </div>
                                                </div>
                                            </form>
                                        </div>
                                        ...
                                        <div class="card-footer">
                                            <a class="btn btn-danger" href="javascript:clear()">Clear all</a>
                                            <!-- <a class="btn btn-success" href="javascript:resend()">Resend</a> -->
                                        </div>
                                    </div>
                                    <!-- /.card -->
                                </div>
