	...
	(function (factory) {
		...
		( /** @lends <global> */ function ($) {
			...
			function _fnFeatureHtmlFilter(settings) {
				...
				var input = '<input type="search" class="' + classes.sFilterInput + ' " style="border:2px solid #428bca;"/>';
		...
		'column().search()'
			...
			DataTable.defaults = {
				...
				"oLanguage": {
					 ...
					 *    } );
					 */
					"sInfoEmpty": "Mostrando 0 de 0 de 0 registos",
					 ...
					 *    } );
					 */
					"sZeroRecords": "Não foram encontrados registos coincidentes com a informação inserida"
				},
