...
function insert() {
    ...
    if (email_add.val() == "") {
        updateTips(tips, "Please fill in the email");
        email_add.focus();
    } else if (username_add.val() == "") {
        updateTips(tips, "Please fill in the username");
        username_add.focus();
    } else if (password_add.val() == "") {
        updateTips(tips, "Please fill in password");
        password_add.focus();
        ...
        updateTips(tips, "The password cannot contain the user name");
        username_add.focus();
    } else {
