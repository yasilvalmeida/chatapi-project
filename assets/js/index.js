    ...
    $("#email").keyup((e) => {
        ...
        if (code == 13) {
            ...
            if (email.val() == "") {
                ...
                tips.html("You must enter the email.");
                email.focus();
            } else if (password.val() == "") {
                tips.addClass("alert alert-danger");
                tips.html("You must enter the password.");
                password.focus();
            } else if (email.val() == password.val()) {
                tips.addClass("alert-danger");
                tips.html("The email must be different from the password.");
                password.focus();
            } else {
                ...
                bValid =
                    ...
                    checkRegexp(
                        ...
                        "Please enter a valid email address, for example: account@domain.com",
                        tips
                    );
                ...
                bValid =
                    ...
                    checkRegexp(
                        password,
                        /[@£€§#$%&*+-?!~^ºª]/,
                        "The password must contain a special character, such as: *, &, $, @ or #.",
                        tips
                    );
                if (bValid) {
                    loginAsync();
...
checkLength = (o, n, min, max, tips) => {
    if (o.val().length > max || o.val().length < min) {
        ...
        updateTips(
            tips,
            "The longitude of " + n + " must be between " + min + " and " + max + "."
        );
        return false;
    } else {
        return true;
