$(function() {
    ...
    if (logged_access == 0) {
        ...
        $("#user_nav").html('<li class="nav-item"><a class="nav-link" href="main.php"><i class="fas fa-tachometer-alt"></i><span>Main</span></a></li><li class="nav-item"><a class="nav-link" href="contact.php"><i class="fas fa-address-card"></i><span>Contacts</span></a></li><li class="nav-item"><a class="nav-link" href="group.php"><i class="fas fa-users"></i><span>Groups</span></a></li><li class="nav-item"><a class="nav-link" href="send-message.php"><i class="fas fa-sms"></i><span>Send Message</span></a></li>');
    }
